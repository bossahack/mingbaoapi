...
namespace Book.Dal.Model
{
    ...
    public class ColumnMapper
    {
        public static void SetMapper()
        {
            ...
            SqlMapper.SetTypeMap(typeof(ShopMonthOrder), new ColumnAttributeTypeMapper<ShopMonthOrder>());
            ...
            SqlMapper.SetTypeMap(typeof(PhoneCodeRecord), new ColumnAttributeTypeMapper<PhoneCodeRecord>());
